...
public class test extends JPanel{
    ...
    public test(){
        trangChua_TieuDe = new JPanel();
        tieuDe = new JLabel();
        trangChua_ThanhTimKiem = new JPanel();
        timKiemVe = new JLabel();
        thanhTimKiem = new  JTextField();
        trangChua_ThongTinChiTiet = new  JPanel();
        tragChua_TieuDeThongTinChiTiet = new  JPanel();
        tieuDe_ThongTinChiTiet = new  JLabel();
        trangChua_ThongTinKhachang = new  JPanel();
        trangChua_TenKhachHang = new  JPanel();
        tieuDe_TenKhachHang = new  JLabel();
        thanhTenKhachHang = new  JTextField();
        trangChua_SoDienThoai = new  JPanel();
        tieuDe_SoDienThoai = new  JLabel();
        thanhSoDienThoai = new  JTextField();
        trangChua_Email = new  JPanel();
        tieuDe_Email = new  JLabel();
        thanhEmail = new  JTextField();
        trangChua_ThongTinVe = new  JPanel();
        trangChua_SoHieu = new  JPanel();
        tieuDe_SoHieu = new  JLabel();
        thanhSoHieu = new  JTextField();
        trangChua_ThongTinNgayDi = new  JPanel();
        tieuDe_NgayDi = new  JLabel();
        thanhNgayDi = new  JTextField();
        trangChua_ThongTinNgayVe = new  JPanel();
        tieuDe_NgayVe = new  JLabel();
        thanhNgayVe = new  JTextField();
        trangChua_ThongTinSoLuong = new  JPanel();
        tieuDe_SoLuong = new  JLabel();
        thanhSoLuong = new  JTextField();
        trangChua_ThongTinSoTien = new  JPanel();
        trangChua_DonGia = new  JPanel();
        tieuDe_DonGia = new  JLabel();
        trangChua_VeNguoiLon = new  JPanel();
        tieuDeVeNguoiLon = new  JLabel();
        soTienVeNguoiLon = new  JLabel();
        trangChua_VeTreEm = new  JPanel();
        tieuDeVeTreEm = new  JLabel();
        soTienVeTreEm = new  JLabel();
        trangChua_TongTien = new  JPanel();
        tieuDeTongTien = new  JLabel();
        tongTien = new  JLabel();
        trangChua_DanhSachVe = new  JPanel();
        trangChua_TableDanhSach = new  JPanel();
        scrollpane = new  JScrollPane();
        table = new  JTable();
        trangChua_ChiTietCacCongCu = new  JPanel();
        trangChua_CongCu = new  JPanel();
        capNhat = new  JButton();
        xoa = new  JButton();  
        lamMoi = new  JButton();
...
//        this.setLocationRelativeTo(null);
    ...
    private void thietLap_TrangChuaTieuDe(){
        this.tieuDe.setText("Danh Sách Bán Vé Tàu");
        ...
        trangChua_ThanhTimKiemLayout.setHorizontalGroup(
                trangChua_ThanhTimKiemLayout.createParallelGroup( GroupLayout.Alignment.LEADING)
                        .addGroup(trangChua_ThanhTimKiemLayout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addComponent(timKiemVe,  GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE)
                                .addGap(28, 28, 28)
                                .addComponent(thanhTimKiem,  GroupLayout.PREFERRED_SIZE, 275,  GroupLayout.PREFERRED_SIZE)
                                .addContainerGap())
        );
...
//        trangChua_ThongTinKhachang.setBackground(new java.awt.Color(0, 255, 51));
        ...
        tieuDe_TenKhachHang.setText("Tên Khách hàng");

        thanhTenKhachHang.setText("jTextField2");
        ...
        thanhSoDienThoai.setText("jTextField2");
    ...
    private void thietLap_TrangChuaThongTinSoTien(){
        //trangChua_ThongTinSoTien.setBackground(new java.awt.Color(255, 51, 51));
    ...
    private void thietLap_TrangChuaCongCuHoTro(){
        capNhat.setText("jButton1");;

        xoa.setText("jButton2");

        lamMoi.setText("jButton3");
